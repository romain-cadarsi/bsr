...
class GeneralCrudController extends AbstractCrudController
{
   ...
   public function configureActions(Actions $actions): Actions
   {
    ...
    {
        return [
            ImageField::new('logoSombre')->setBasePath('images/upload/')->setUploadDir('public/images/upload')->setUploadedFileNamePattern("logo-dark.png")->setRequired(false)->setHelp('Ce logo sera utilisé pour les menu clairs (Ce logo doit donc avoir des textes noirs)')->hideOnIndex(),
            ImageField::new('logoClair')->setBasePath('images/upload/')->setUploadDir('public/images/upload')->setUploadedFileNamePattern("logo-light.png")->setRequired(false)->setHelp('Ce logo sera utilisé pour les menu sombres (Ce logo doit donc avoir des textes blancs)')->hideOnIndex(),
