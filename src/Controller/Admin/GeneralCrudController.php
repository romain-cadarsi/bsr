    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            ImageField::new('logoPetit')
                ...
                ->setRequired(false)
                ->setHelp('Ce logo sera utilisé sur les menus mobiles')
                ->hideOnIndex(),
            ...
            TextField::new('slogan')
                ->setRequired(false)
                ->setHelp("Correspond a la phrase sur l'image d'accueil"),
            TextEditorField::new('quiSommesNous')
                ->addJsFiles('js/trixFileUpload.js')
                ->setRequired(false)
                ->setHelp("Le texte affiché dans la partie Qui Sommes Nous"),
            ...
            ImageField::new('imageNosChiffresCles')
                ...
                ->setUploadDir('public/images/upload')
                ->setRequired(false)
                ->setUploadedFileNamePattern('chiffresCles.png'),
